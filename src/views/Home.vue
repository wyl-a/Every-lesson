...
<script>
import FTtitle from "../components/FT_title";
import Vue from 'vue';
...
export default {
  ...
  methods: {
    // getBannerImgs() {
    //   this.$APP.banner(client).then(res=>{
    //     console.log('asdf');
    //     console.log(res);
    //   })
    // },
