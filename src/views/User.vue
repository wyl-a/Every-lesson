<template>
  <div class="wyl_user">
    ...
    <div class="wyl_user_course_Sudoku">
      <div class="wyl_user_course_Sudoku_box">
        <p style="font-size: 0.7rem">课程相关</p>
        <UserBox>
          <UserItem :list="lists"></UserItem>
        </UserBox>
      </div>
    </div>
    ...
    <div class="wyl_user_course_Sudoku">
      <div class="wyl_user_course_Sudoku_box">
        <p style="font-size: 0.7rem">订单相关</p>
        <UserBox>
          <UserItem :list="list"></UserItem>
        </UserBox>
      </div>
    </div>
    ...
    <div class="wyl_user_course_Sudoku">
      <div class="wyl_user_course_Sudoku_box">
        <p style="font-size: 0.7rem">我的账号</p>
        <UserBox>
          <UserItem :list="liste"></UserItem>
        </UserBox>
      </div>
    </div>
    ...
    <div class="wyl_user_course_Sudoku">
      <div class="wyl_user_course_Sudoku_box">
        <p style="font-size: 0.7rem">自助服务</p>
        <UserBox>
          <UserItem :list="nei"></UserItem>
        </UserBox>
      </div>
    </div>
